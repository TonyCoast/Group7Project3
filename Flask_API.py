...
file_paths = {
    ...
    'National_CPI': os.path.join(base_dir, 'CPI_PPI_Nationally', 'Merged_CPI_Data.csv'),
    'National_PPI': os.path.join(base_dir, 'CPI_PPI_Nationally', 'Merged_PPI_Data.csv')
}
...
def home():
    return (
        ...
        f"/api/v1.0/National_CPI - National CPI data<br/>"
        f"/api/v1.0/National_PPI - National PPI data<br/>"
    )
...
@app.route("/api/v1.0/National_CPI")
def national_cpi():
    return jsonify(json_data['National_CPI'])

@app.route("/api/v1.0/National_PPI")
def national_ppi():
    return jsonify(json_data['National_PPI'])
